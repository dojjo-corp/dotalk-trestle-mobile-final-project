class LongTextInHtml {
  const LongTextInHtml();
...
For the purposes of this Privacy Policy:
  ...
  * Application refers to DoTalk, the software program provided by the
    Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to Dojjo Corp, 12 Alpina St..
...
If you have any questions about this Privacy Policy, You can contact us:
  ...
  * By email: hosuatetteh@gmail.com

  * By phone number: +233-54-610-2771
...
At DoTalk, we're dedicated to providing exceptional customer service and support to ensure that your needs are met with the utmost care. Our team of dedicated agents is here to assist you every step of the way, whether you have questions, concerns, or simply want to chat.

Our mission is to create a seamless communication experience that connects customers and agents in real time. We understand the importance of efficient problem-solving and timely responses, and that's exactly what you can expect from us.

As we continue to grow and expand, we remain committed to delivering top-notch service, embracing innovation, and fostering strong relationships with our valued users.

Thank you for choosing DoTalk for your customer service needs. We're here to make your experience exceptional and hassle-free.

Feel free to reach out to us at hosuatetteh@gmail.com if you have any feedback, suggestions, or inquiries. We're excited to be part of your journey!
